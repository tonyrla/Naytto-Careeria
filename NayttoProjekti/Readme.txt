...
Tietorakenteena käytän useata List-oliota ajonaikaiseen käyttöön ja ohjelmasta hallitusti poistuttaessa serialisoin datan jokaisen moduulin omaan JSON tiedostoon, mitkä ladataan muistiin ohjelman käynnistyessä.
